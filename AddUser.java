    ...
    private void initialize() {
        ...
        accueil.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // Ouvrir la page SearchPageAdmin et fermer AddUser
                new SearchPageAdmin(userId); // Pass the userId back
                dispose();
            }
        });
        ...
        RoundedButton boutonValider = new RoundedButton("Ajouter", arcWidth, arcHeight, lightGrayColor);
        ...
        boutonValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean isSuccess = db.addUser(nom, prenom, dateNaissance, noRue, rue, codePostal, email, password,
                        profil);
                db.close();
                ...
                if (isSuccess) {
                    ...
                    JOptionPane.showMessageDialog(null, "Erreur lors de l'ajout de l'utilisateur.", "Erreur",
