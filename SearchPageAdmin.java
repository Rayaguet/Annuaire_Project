...
public class SearchPageAdmin extends JFrame {
    final private Font mainFont = new Font("Times New Roman", Font.BOLD, 18);
    RoundedTextField tfSearch;
    private int userId;

    public SearchPageAdmin(int userId) {
        this.userId = userId;
        initialize();
    }

    private void initialize() {
        setTitle("Search Page Admin");
        setSize(800, 600);
        ...
        ImageIcon userIcon = new ImageIcon("images/adminlogo.png");
        ...
        searchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                List<Infosuserforadmin.User> users = new ArrayList<>();
                try {
                    while (rs != null && rs.next()) {
                        ...
                        Infosuserforadmin.User user = new Infosuserforadmin.User(
        ...
        menuButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JMenuItem addUser = new JMenuItem("Ajouter User");
                JMenuItem addAdmin = new JMenuItem("Ajouter Admin");
